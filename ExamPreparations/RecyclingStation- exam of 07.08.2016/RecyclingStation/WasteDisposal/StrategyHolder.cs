namespace RecyclingStation.WasteDisposal
{
    ...
    public class StrategyHolder : IStrategyHolder
    {
        ...
        public bool AddStrategy(Type disposableAttribute, IGarbageDisposalStrategy strategy)
        {
            ...
            if (!this.DoesContainStrategy(disposableAttribute))
            {
        ...
        private bool DoesContainStrategy(Type disposableAttribute)
        {
            bool doesExist = this.strategies.ContainsKey(disposableAttribute);
            return doesExist;
        }
    }
}
